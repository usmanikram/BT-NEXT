  ...
  return (
    <div className="rounded-3xl bg-gradient-to-br from-white to-cream-soft p-8 sm:p-10 shadow-[0_24px_60px_rgba(31,26,20,0.08)]">
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="mt-8 font-display text-3xl font-semibold tracking-tight">Forgot password?</h1>
        <p className="mt-3 text-sm text-ink-soft max-w-sm">
          Enter your email and we&apos;ll send you a link to set a new one. The link expires in 1 hour.
        </p>
      </div>
      <div className="mt-8">
        <ForgotForm />
